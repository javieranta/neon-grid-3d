...
void main() {
	...
	`}function J0(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===ta||l===na,u=l===Yi||l===Zi;if(c||u){let h=e.get(a);const f=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return t===null&&(t=new Hr(i)),h=c?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const p=a.image;return c&&p&&p.height>0||u&&p&&s(p)?(t===null&&(t=new Hr(i)),h=c?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",r),h.texture):null}}}return a}function s(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function K0(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&Fi("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function j0(i,e,t,n){const s={},r=new WeakMap;function o(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);f.removeEventListener("dispose",o),delete s[f.id];const p=r.get(f);p&&(e.remove(p),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function a(h,f){return s[f.id]===!0||(f.addEventListener("dispose",o),s[f.id]=!0,t.memory.geometries++),f}function l(h){const f=h.attributes;for(const p in f)e.update(f[p],i.ARRAY_BUFFER)}function c(h){const f=[],p=h.index,g=h.attributes.position;let v=0;if(p!==null){const E=p.array;v=p.version;for(let b=0,S=E.length;b<S;b+=3){const A=E[b+0],x=E[b+1],y=E[b+2];f.push(A,x,x,y,y,A)}}else if(g!==void 0){const E=g.array;v=g.version;for(let b=0,S=E.length/3-1;b<S;b+=3){const A=b+0,x=b+1,y=b+2;f.push(A,x,x,y,y,A)}}else return;const m=new(Cu(f)?Uu:Iu)(f,1);m.version=v;const d=r.get(h);d&&e.remove(d),r.set(h,m)}function u(h){const f=r.get(h);if(f){const p=h.index;p!==null&&f.version<p.version&&c(h)}else c(h);return r.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function Q0(i,e,t){let n;function s(f){n=f}let r,o;function a(f){r=f.type,o=f.bytesPerElement}function l(f,p){i.drawElements(n,p,r,f*o),t.update(p,n,1)}function c(f,p,g){g!==0&&(i.drawElementsInstanced(n,p,r,f*o,g),t.update(p,n,g))}function u(f,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,f,0,g);let m=0;for(let d=0;d<g;d++)m+=p[d];t.update(m,n,1)}function h(f,p,g,v){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)c(f[d]/o,p[d],v[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,f,0,v,0,g);let d=0;for(let E=0;E<g;E++)d+=p[E]*v[E];t.update(d,n,1)}}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function eg(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(r/3);break;case i.LINES:t.lines+=a*(r/2);break;case i.LINE_STRIP:t.lines+=a*(r-1);break;case i.LINE_LOOP:t.lines+=a*r;break;case i.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function tg(i,e,t){const n=new WeakMap,s=new lt;function r(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let f=n.get(a);if(f===void 0||f.count!==h){let _=function(){C.dispose(),n.delete(a),a.removeEventListener("dispose",_)};var p=_;f!==void 0&&f.texture.dispose();const g=a.morphAttributes.position!==void 0,v=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],E=a.morphAttributes.normal||[],b=a.morphAttributes.color||[];let S=0;g===!0&&(S=1),v===!0&&(S=2),m===!0&&(S=3);let A=a.attributes.position.count*S,x=1;A>e.maxTextureSize&&(x=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const y=new Float32Array(A*x*4*h),C=new Pu(y,A,x,h);C.type=mn,C.needsUpdate=!0;const M=S*4;for(let L=0;L<h;L++){const D=d[L],U=E[L],N=b[L],O=A*x*4*L;for(let F=0;F<D.count;F++){const X=F*M;g===!0&&(s.fromBufferAttribute(D,F),y[O+X+0]=s.x,y[O+X+1]=s.y,y[O+X+2]=s.z,y[O+X+3]=0),v===!0&&(s.fromBufferAttribute(U,F),y[O+X+4]=s.x,y[O+X+5]=s.y,y[O+X+6]=s.z,y[O+X+7]=0),m===!0&&(s.fromBufferAttribute(N,F),y[O+X+8]=s.x,y[O+X+9]=s.y,y[O+X+10]=s.z,y[O+X+11]=N.itemSize===4?s.w:1)}}f={count:h,texture:C,size:new ie(A,x)},n.set(a,f),a.addEventListener("dispose",_)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const v=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",v),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function ng(i,e,t,n){let s=new WeakMap;function r(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(s.get(h)!==c&&(e.update(h),s.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;s.get(f)!==c&&(f.update(),s.set(f,c))}return h}function o(){s=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:o}}const rh=new Nt,bc=new Xu(1,1),oh=new Pu,ah=new Qf,lh=new Bu,Tc=[],wc=[],Ac=new Float32Array(16),Cc=new Float32Array(9),Rc=new Float32Array(4);function is(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=Tc[s];if(r===void 0&&(r=new Float32Array(s),Tc[s]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(r,a)}return r}function Tt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function wt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Yr(i,e){let t=wc[e];t===void 0&&(t=new Int32Array(e),wc[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function ig(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function sg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Tt(t,e))return;i.uniform2fv(this.addr,e),wt(t,e)}}function rg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Tt(t,e))return;i.uniform3fv(this.addr,e),wt(t,e)}}function og(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Tt(t,e))return;i.uniform4fv(this.addr,e),wt(t,e)}}function ag(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Tt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),wt(t,e)}else{if(Tt(t,n))return;Rc.set(n),i.uniformMatrix2fv(this.addr,!1,Rc),wt(t,n)}}function lg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Tt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),wt(t,e)}else{if(Tt(t,n))return;Cc.set(n),i.uniformMatrix3fv(this.addr,!1,Cc),wt(t,n)}}function cg(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Tt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),wt(t,e)}else{if(Tt(t,n))return;Ac.set(n),i.uniformMatrix4fv(this.addr,!1,Ac),wt(t,n)}}function ug(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function hg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Tt(t,e))return;i.uniform2iv(this.addr,e),wt(t,e)}}function fg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Tt(t,e))return;i.uniform3iv(this.addr,e),wt(t,e)}}function dg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Tt(t,e))return;i.uniform4iv(this.addr,e),wt(t,e)}}function pg(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function mg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Tt(t,e))return;i.uniform2uiv(this.addr,e),wt(t,e)}}function gg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Tt(t,e))return;i.uniform3uiv(this.addr,e),wt(t,e)}}function vg(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Tt(t,e))return;i.uniform4uiv(this.addr,e),wt(t,e)}}function _g(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(bc.compareFunction=Au,r=bc):r=rh,t.setTexture2D(e||r,s)}function xg(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||ah,s)}function Mg(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||lh,s)}function yg(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||oh,s)}function Sg(i){switch(i){case 5126:return ig;case 35664:return sg;case 35665:return rg;case 35666:return og;case 35674:return ag;case 35675:return lg;case 35676:return cg;case 5124:case 35670:return ug;case 35667:case 35671:return hg;case 35668:case 35672:return fg;case 35669:case 35673:return dg;case 5125:return pg;case 36294:return mg;case 36295:return gg;case 36296:return vg;case 35678:case 36198:case 36298:case 36306:case 35682:return _g;case 35679:case 36299:case 36307:return xg;case 35680:case 36300:case 36308:case 36293:return Mg;case 36289:case 36303:case 36311:case 36292:return yg}}function Eg(i,e){i.uniform1fv(this.addr,e)}function bg(i,e){const t=is(e,this.size,2);i.uniform2fv(this.addr,t)}function Tg(i,e){const t=is(e,this.size,3);i.uniform3fv(this.addr,t)}function wg(i,e){const t=is(e,this.size,4);i.uniform4fv(this.addr,t)}function Ag(i,e){const t=is(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Cg(i,e){const t=is(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Rg(i,e){const t=is(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Pg(i,e){i.uniform1iv(this.addr,e)}function Lg(i,e){i.uniform2iv(this.addr,e)}function Dg(i,e){i.uniform3iv(this.addr,e)}function Ig(i,e){i.uniform4iv(this.addr,e)}function Ug(i,e){i.uniform1uiv(this.addr,e)}function Ng(i,e){i.uniform2uiv(this.addr,e)}function Fg(i,e){i.uniform3uiv(this.addr,e)}function Og(i,e){i.uniform4uiv(this.addr,e)}function Bg(i,e,t){const n=this.cache,s=e.length,r=Yr(t,s);Tt(n,r)||(i.uniform1iv(this.addr,r),wt(n,r));for(let o=0;o!==s;++o)t.setTexture2D(e[o]||rh,r[o])}function zg(i,e,t){const n=this.cache,s=e.length,r=Yr(t,s);Tt(n,r)||(i.uniform1iv(this.addr,r),wt(n,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||ah,r[o])}function kg(i,e,t){const n=this.cache,s=e.length,r=Yr(t,s);Tt(n,r)||(i.uniform1iv(this.addr,r),wt(n,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||lh,r[o])}function Hg(i,e,t){const n=this.cache,s=e.length,r=Yr(t,s);Tt(n,r)||(i.uniform1iv(this.addr,r),wt(n,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||oh,r[o])}function Gg(i){switch(i){case 5126:return Eg;case 35664:return bg;case 35665:return Tg;case 35666:return wg;case 35674:return Ag;case 35675:return Cg;case 35676:return Rg;case 5124:case 35670:return Pg;case 35667:case 35671:return Lg;case 35668:case 35672:return Dg;case 35669:case 35673:return Ig;case 5125:return Ug;case 36294:return Ng;case 36295:return Fg;case 36296:return Og;case 35678:case 36198:case 36298:case 36306:case 35682:return Bg;case 35679:case 36299:case 36307:return zg;case 35680:case 36300:case 36308:case 36293:return kg;case 36289:case 36303:case 36311:case 36292:return Hg}}class Vg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Sg(t.type)}}class Wg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Gg(t.type)}}class Xg{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,t[a.id],n)}}}const Go=/(\w+)(\])?(\[|\.)?/g;function Pc(i,e){i.seq.push(e),i.map[e.id]=e}function qg(i,e,t){const n=i.name,s=n.length;for(Go.lastIndex=0;;){const r=Go.exec(n),o=Go.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){Pc(t,c===void 0?new Vg(a,i,e):new Wg(a,i,e));break}else{let h=t.map[a];h===void 0&&(h=new Xg(a),Pc(t,h)),t=h}}}class Dr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),o=e.getUniformLocation(t,r.name);qg(r,o,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,o=t.length;r!==o;++r){const a=t[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in t&&n.push(o)}return n}}function Lc(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Yg=37297;let Zg=0;function $g(i,e){const t=i.split(`
...
`+$g(i.getShaderSource(e),o)}else return s}function Kg(i,e){const t=Jg(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function jg(i,e){let t;switch(e){case uu:t="Linear";break;case hu:t="Reinhard";break;case fu:t="Cineon";break;case Wa:t="ACESFilmic";break;case du:t="AgX";break;case pu:t="Neutral";break;case vf:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Mr=new I;function Qg(){je.getLuminanceCoefficients(Mr);const i=Mr.x.toFixed(4),e=Mr.y.toFixed(4),t=Mr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function ev(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(xs).join(`
`)}function tv(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function nv(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function xs(i){return i!==""}function Uc(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Nc(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const iv=/^[ \t]*#include +<([\w\d./]+)>/gm;function Na(i){return i.replace(iv,rv)}const sv=new Map;function rv(i,e){let t=Xe[e];if(t===void 0){const n=sv.get(e);if(n!==void 0)t=Xe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Na(t)}const ov=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Fc(i){return i.replace(ov,av)}function av(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Oc(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function lv(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===au?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===lu?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===An&&(e="SHADOWMAP_TYPE_VSM"),e}function cv(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Yi:case Zi:e="ENVMAP_TYPE_CUBE";break;case Gr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function uv(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Zi:e="ENVMAP_MODE_REFRACTION";break}return e}function hv(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case cu:e="ENVMAP_BLENDING_MULTIPLY";break;case mf:e="ENVMAP_BLENDING_MIX";break;case gf:e="ENVMAP_BLENDING_ADD";break}return e}function fv(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function dv(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=lv(t),c=cv(t),u=uv(t),h=hv(t),f=fv(t),p=ev(t),g=tv(r),v=s.createProgram();let m,d,E=t.glslVersion?"#version "+t.glslVersion+`
...
uniform vec3 uGhostRim;`).replace("#include <emissivemap_fragment>",`#include <emissivemap_fragment>
  ...
  totalEmissiveRadiance += uGhostRim * pow(ghostRim, 2.4) * 1.6;`)};const a=new bt(Sr,e.ghostSegments,Math.max(10,e.ghostSegments/2),0,Math.PI*2,0,Math.PI/2),l=new ge(a,r);l.castShadow=e.shadows,s.add(l);const c=Yv(Sr,.42),u=new ge(c,r);u.castShadow=e.shadows,s.add(u);const h=new et({color:t.glow,transparent:!0,opacity:.3,blending:Ct,depthWrite:!1,side:Ut,toneMapped:!1}),f=new ge(new bt(Sr*1.42,22,16),h);f.position.y=-.13,s.add(f);const p=new $e,g=new kr({color:Ze.ghostEyeWhite,emissive:new fe(8952268),emissiveIntensity:.35,roughness:.25}),v=new kr({color:Ze.ghostPupil,emissive:new fe(2237098),emissiveIntensity:.45,roughness:.2}),m=new bt(.155,20,16),d=new bt(.082,16,14),E=[];for(const B of[-1,1]){const se=new ge(m,g);se.position.set(B*.168,.125,.275),se.scale.set(1,1.18,.8);const re=new ge(d,v);re.position.set(B*.168,.125,.395),p.add(se,re),E.push({white:se,pupil:re,side:B})}n.add(p);const b=new _n({color:656408,roughness:.12,clearcoat:1,clearcoatRoughness:.06,metalness:0}),S=new Gt(.2,.055,.055),A=[];for(const B of[-1,1]){const se=new ge(S,b);se.position.set(B*.175,.265,.315),se.rotation.z=B*.42,A.push(se),n.add(se)}const x=new et({map:Zv(),transparent:!0,depthWrite:!1,toneMapped:!1,side:gt}),y=new ge(new un(.46,.2),x);y.position.set(0,-.09,Sr*.94),y.visible=!1,n.add(y);const C=Zr(t.glow,2.3,.3);C.position.y=-.05,n.add(C);const M=uh(t.colour,2.6,.4);let _=null;e.ghostLights&&(_=new qr(t.colour,1.7,5.2,2),_.position.y=.1,n.add(_));const L=c.attributes.position,D=c.userData.baseHeight,U=c.userData.bottomStart,N=c.userData.bottomCount,O=new fe(Ze.frightened),F=new fe(Ze.frightenedFlash),X=new fe(t.colour);return{root:n,pool:M,setLights(B){_&&(_.visible=B)},update(B,se,re){const pe=Vn(B.x),Ne=Wn(B.y);n.position.set(pe,Vc,Ne),M.position.set(pe,.012,Ne);const He=B.state==="eaten";s.visible=!He,C.visible=!He,M.visible=!He;const G=se*7+(B.x+B.y)*.6;for(let Q=0;Q<N;Q++){const Ee=Q/ii*Math.PI*2,Pe=Math.abs(Math.sin(Ee*qv*.5+G))*.11;L.setY(U+Q,-D+Pe)}L.needsUpdate=!0;const Y=Dn[B.eyeDir??B.dir]??Dn.left;for(const Q of E)Q.pupil.position.x=Q.side*.168+Y.x*.055,Q.pupil.position.y=.125-Y.y*.055,Q.pupil.position.z=.395-Math.abs(Y.y)*.02;const ce=Math.sin(se*5.5+G*.1)*.02;if(n.position.y=Vc+ce,B.frightened){r.color.copy(re?F:O),r.emissive.copy(re?F:O),r.emissiveIntensity=re?1.1:.85,h.color.copy(re?F:O),o&&o.value.copy(re?F:O),y.visible=!He,x.color.copy(re?new fe(2833663):F);for(const Q of E)Q.pupil.visible=!1;for(const Q of A)Q.visible=!1;_&&_.color.copy(re?F:O)}else{r.color.copy(X),r.emissive.copy(X),r.emissiveIntensity=.7+.12*Math.sin(se*4+G*.2),h.color.setHex(t.glow),o&&o.value.setHex(t.glow),y.visible=!1;for(const Q of E)Q.pupil.visible=!0;for(const Q of A)Q.visible=!He;_&&_.color.setHex(t.colour)}_&&(_.intensity=He?.5:1.5+.35*Math.sin(se*5))}}}function $v(i,e){const t=i.pelletsInitial.filter(g=>!g.energizer),n=new bt(.15,e.pelletSegments+2,e.pelletSegments),s=new et({color:Ze.pellet,toneMapped:!1}),r=new Co(n,s,t.length);r.instanceMatrix.setUsage(oo),r.frustumCulled=!1;const o=new bt(.15,14,10),a=new et({color:16767091,transparent:!0,opacity:.1,blending:Ct,depthWrite:!1,toneMapped:!1}),l=new Co(o,a,t.length);l.instanceMatrix.setUsage(oo),l.frustumCulled=!1,l.renderOrder=6;const c=new Co(n,new et({color:Ze.pellet,toneMapped:!1,transparent:!0,opacity:.55,depthWrite:!1,side:gt}),t.length);c.instanceMatrix.setUsage(oo),c.frustumCulled=!1,c.renderOrder=-2;const u=t.map(g=>({...g,eaten:!1,pop:0})),h=new xt;return{mesh:r,halo:l,reflection:c,sync:g=>{for(let v=0;v<u.length;v++){const m=u[v],d=i.pelletAt(m.x,m.y)===0;d&&!m.eaten&&(m.eaten=!0,m.pop=1),!d&&m.eaten&&(m.eaten=!1,m.pop=0);let E;m.eaten?(m.pop=Math.max(0,m.pop-.075),E=m.pop>0?(1+(1-m.pop)*1.8)*m.pop:0):E=.86+.14*Math.sin(g*4.5+(m.x+m.y)*.9),h.position.set(Vn(m.x),.2+(m.eaten?(1-m.pop)*.4:0),Wn(m.y)),h.scale.setScalar(E),h.rotation.set(0,g*.6+m.x,0),h.updateMatrix(),r.setMatrixAt(v,h.matrix),h.scale.multiplyScalar(1.9),h.updateMatrix(),l.setMatrixAt(v,h.matrix)}r.instanceMatrix.needsUpdate=!0,l.instanceMatrix.needsUpdate=!0,c.visible&&(c.instanceMatrix.array.set(r.instanceMatrix.array),c.instanceMatrix.needsUpdate=!0)},reset:()=>{for(const g of u)g.eaten=!1,g.pop=0}}}function Jv(i,e){const t=new $e,n=i.pelletsInitial.filter(o=>o.energizer),s=new et({color:Ze.energizer,toneMapped:!1}),r=n.map(o=>{const a=new $e,l=new ge(new bt(.3,24,20),s);a.add(l);const c=Zr(16773280,2.2,.7);a.add(c);const u=new ge(new Is(.3,.022,8,28),new et({color:16771488,toneMapped:!1,transparent:!0,opacity:.8,blending:Ct,depthWrite:!1}));u.rotation.x=Math.PI/2,a.add(u),a.position.set(Vn(o.x),.3,Wn(o.y)),t.add(a);let h=null;return e.energizerLights&&(h=new qr(16773296,2.2,6,2),h.position.y=.1,a.add(h)),{tile:o,holder:a,halo:c,ring:u,light:h,core:l}});return{group:t,setLights(o){for(const a of r)a.light&&(a.light.visible=o)},sync(o){for(const a of r){const l=i.pelletAt(a.tile.x,a.tile.y)!==0;if(a.holder.visible=l,!l){a.light&&(a.light.intensity=0);continue}const c=.72+.28*Math.sin(o*7+a.tile.x);a.core.scale.setScalar(.82+c*.3),a.halo.scale.setScalar(1.9+c*1.5),a.halo.material.opacity=.45+c*.4,a.ring.scale.setScalar(.9+c*.5),a.ring.rotation.z=o*1.4,a.holder.position.y=.3+Math.sin(o*3+a.tile.y)*.03,a.light&&(a.light.intensity=1.4+c*1.8)}}}}function Pt(i,e=.7,t=.3){return new _n({color:i,emissive:new fe(i),emissiveIntensity:e,metalness:.2,roughness:t,clearcoat:1,clearcoatRoughness:.12})}const Xc={cherry(){const i=new $e,e=Pt(16722770,.8);for(const n of[-.13,.13]){const s=new ge(new bt(.16,20,16),e);s.position.set(n,-.06,n*.4),i.add(s)}const t=Pt(5111695,.55);for(const n of[-.13,.13]){const s=new ge(new an(.014,.014,.3,6),t);s.position.set(n*.55,.16,n*.2),s.rotation.z=-n*1.6,i.add(s)}return i},strawberry(){const i=new $e,e=new ge(new Wi(.2,.36,20),Pt(16723819,.8));e.rotation.x=Math.PI,e.position.y=-.04,i.add(e);const t=new ge(new Wi(.18,.09,6),Pt(6160266,.6));return t.position.y=.16,i.add(t),i},orange(){const i=new $e;i.add(new ge(new bt(.2,22,18),Pt(16753193,.85)));const e=new ge(new an(.02,.02,.1,6),Pt(5111695,.5));return e.position.y=.22,i.add(e),i},apple(){const i=new $e,e=new ge(new bt(.2,22,18),Pt(16724821,.85));e.scale.set(1,.94,1),i.add(e);const t=new ge(new an(.018,.018,.14,6),Pt(9132587,.4));t.position.y=.22,i.add(t);const n=new ge(new bt(.07,10,8),Pt(6160266,.6));return n.scale.set(1.6,.3,.8),n.position.set(.08,.25,0),i.add(n),i},melon(){const i=new $e;i.add(new ge(new bt(.21,24,18),Pt(7208796,.7)));const e=Pt(1010474,.4);for(let t=0;t<5;t++){const n=new ge(new Is(.212,.012,6,24,Math.PI),e);n.rotation.y=t/5*Math.PI,n.rotation.x=Math.PI/2,i.add(n)}return i},galaxian(){const i=new $e,e=new ge(new Wi(.12,.34,4),Pt(5101823,.9));e.rotation.y=Math.PI/4,i.add(e);const t=Pt(16769357,.9);for(const n of[-1,1]){const s=new ge(new Gt(.2,.03,.1),t);s.position.set(n*.16,-.08,0),s.rotation.z=n*.5,i.add(s)}return i},bell(){const i=new $e,e=new ge(new bt(.2,22,14,0,Math.PI*2,0,Math.PI/2),Pt(16765517,.85));i.add(e);const t=new ge(new an(.2,.22,.12,22,1,!0),Pt(16765517,.85));t.position.y=-.06,i.add(t);const n=new ge(new bt(.05,12,10),Pt(16735432,.9));return n.position.y=-.16,i.add(n),i},key(){const i=new $e,e=Pt(9234943,.9),t=new ge(new Is(.11,.032,10,22),e);t.position.y=.14,i.add(t);const n=new ge(new an(.03,.03,.3,10),e);n.position.y=-.08,i.add(n);for(const s of[-.14,-.2]){const r=new ge(new Gt(.11,.035,.035),e);r.position.set(.06,s,0),i.add(r)}return i}};function Kv(){const i=new Map;return function(t){if(!i.has(t)){const s=(Xc[t]??Xc.cherry)();s.scale.setScalar(1.7);const r=Zr(16777215,3,.5);s.add(r),i.set(t,s)}return i.get(t)}}function jv(){const i=new $e,e=new Xr(.42,.62,44);e.rotateX(-Math.PI/2);const t=new et({color:16769658,transparent:!0,opacity:.6,blending:Ct,depthWrite:!1,toneMapped:!1,side:gt}),n=new ge(e,t);i.add(n);const s=new an(.34,.62,3.4,20,1,!0);s.translate(0,1.7,0);const r=new _t({transparent:!0,depthWrite:!1,blending:Ct,side:gt,toneMapped:!1,uniforms:{colour:{value:new fe(16766826)},time:{value:0}},vertexShader:`
    ...
    `}),o=new ge(s,r);return i.add(o),{group:i,update(a){const l=.5+.5*Math.sin(a*3.4);n.scale.setScalar(.9+l*.25),n.rotation.y=a*.9,t.opacity=.35+l*.4,r.uniforms.time.value=a}}}const Wo=new Map;function Qv(i){if(Wo.has(i))return Wo.get(i);const e=512,t=256,n=document.createElement("canvas");n.width=e,n.height=t;const s=n.getContext("2d");s.clearRect(0,0,e,t),s.font='bold 150px "Trebuchet MS", "Segoe UI", sans-serif',s.textAlign="center",s.textBaseline="middle",s.lineJoin="round",s.lineWidth=16,s.strokeStyle="rgba(6, 0, 24, 0.92)",s.strokeText(i,e/2,t/2),s.shadowColor="#00e9ff",s.shadowBlur=12,s.fillStyle="#7ef0ff",s.fillText(i,e/2,t/2);const r=new ns(n);return r.colorSpace=Et,Wo.set(i,r),r}function e_(i=8){const e=new $e,t=[];for(let n=0;n<i;n++){const s=new tl({transparent:!0,depthWrite:!1,depthTest:!1,toneMapped:!1}),r=new Gu(s);r.visible=!1,r.scale.set(2.6,1.3,1),e.add(r),t.push(r)}return{group:e,sync(n){for(let s=0;s<t.length;s++){const r=t[s],o=n[s];if(!o){r.visible=!1;continue}const a=o.age/o.life;r.visible=!0;const l=Qv(String(o.points));r.material.map!==l&&(r.material.map=l,r.material.needsUpdate=!0),r.position.set(Vn(o.x),.7+a*1.5,Wn(o.y)),r.material.opacity=1-a*a,r.scale.set(2.6+a*.8,1.3+a*.4,1)}}}}const Fa=.26,Oa=i=>i-14,Ba=i=>15.5-i;function qc(i,e,t){return t<0||t>=ln||e<0||e>=ht?!1:i[t][e]===vt.WALL}function t_(i){const e=new Uint8Array(ht*ln),t=[];for(let n=0;n<ln;n++)for(let s=0;s<ht;s++){if(!qc(i,s,n)||e[n*ht+s])continue;const r=[],o=[[s,n]];for(e[n*ht+s]=1;o.length;){const[a,l]=o.pop();r.push([a,l]);const c=[[a+1,l],[a-1,l],[a,l+1],[a,l-1]];for(const[u,h]of c)u<0||u>=ht||h<0||h>=ln||!qc(i,u,h)||e[h*ht+u]||(e[h*ht+u]=1,o.push([u,h]))}t.push(r)}return t}function n_(i,e){const t=new Set(e.map(([l,c])=>`${l},${c}`)),n=(l,c)=>t.has(`${l},${c}`),s=new Map,r=(l,c,u,h)=>{const f=`${l},${c}`;s.has(f)||s.set(f,[]),s.get(f).push([u,h])};for(const[l,c]of e)n(l,c-1)||r(l+1,c,l,c),n(l,c+1)||r(l,c+1,l+1,c+1),n(l-1,c)||r(l,c,l,c+1),n(l+1,c)||r(l+1,c+1,l+1,c);const o=[];let a=0;for(;s.size&&a++<5e3;){const l=s.keys().next().value;let[c,u]=l.split(",").map(Number);const h=[[c,u]];let f=[c,u],p=0;for(;p++<5e3;){const g=`${f[0]},${f[1]}`,v=s.get(g);if(!v||v.length===0)break;const m=v.shift();if(v.length===0&&s.delete(g),f=m,f[0]===c&&f[1]===u)break;h.push(f)}h.length>=4&&o.push(h)}return o.map(i_)}function i_(i){const e=[],t=i.length;for(let n=0;n<t;n++){const s=i[(n-1+t)%t],r=i[n],o=i[(n+1)%t],a=r[0]-s[0],l=r[1]-s[1],c=o[0]-r[0],u=o[1]-r[1];a*u-l*c!==0&&e.push(r)}return e.length>=4?e:i}function Er(i){let e=0;for(let t=0;t<i.length;t++){const[n,s]=i[t],[r,o]=i[(t+1)%i.length];e+=n*o-r*s}return e/2}function za(i,e,t=5){const n=i.map(([o,a])=>new ie(Oa(o),Ba(a))),s=n.length,r=[];for(let o=0;o<s;o++){const a=n[(o-1+s)%s],l=n[o],c=n[(o+1)%s],u=l.clone().sub(a),h=c.clone().sub(l),f=u.length(),p=h.length();if(f<1e-6||p<1e-6)continue;u.divideScalar(f),h.divideScalar(p);const g=Math.min(e,f*.5,p*.5),v=l.clone().sub(u.clone().multiplyScalar(g)),m=l.clone().add(h.clone().multiplyScalar(g));r.push(v);for(let d=1;d<t;d++){const E=d/t,b=1-E;r.push(new ie(b*b*v.x+2*b*E*l.x+E*E*m.x,b*b*v.y+2*b*E*l.y+E*E*m.y))}r.push(m)}return r}function s_(i,e){const t=i.length;let n=0;for(let o=0;o<t;o++){const a=i[o],l=i[(o+1)%t];n+=a.x*l.y-l.x*a.y}const s=n>0?1:-1,r=[];for(let o=0;o<t;o++){const a=i[o],l=i[(o-1+t)%t],c=i[(o+1)%t],u=c.x-l.x,h=c.y-l.y,f=Math.hypot(u,h)||1,p=-h/f*s*e,g=u/f*s*e;r.push(new ie(a.x+p,a.y+g))}return r}function r_(i,e){const t=new ju(za(i,Fa));for(const n of e)t.holes.push(new Da(za(n,Fa)));return t}function br(i,e,t,n){const s=i.map(a=>new I(a.x,e,-a.y)),r=new qu(s,!0,"catmullrom",.02),o=Math.max(24,Math.min(1200,Math.round(r.getLength()*2.4)));return new al(r,o,t,n,!0)}function o_(){const e=document.createElement("canvas");e.width=e.height=256;const t=e.getContext("2d");t.fillStyle="#000000",t.fillRect(0,0,256,256),t.strokeStyle="rgba(150, 95, 255, 0.14)",t.lineWidth=1;for(let s=4;s<256;s+=8)t.beginPath(),t.moveTo(0,s+.5),t.lineTo(256,s+.5),t.stroke();t.strokeStyle="rgba(215, 150, 255, 0.9)",t.lineWidth=3;for(let s=0;s<256;s+=84)t.beginPath(),t.moveTo(0,s+.5),t.lineTo(256,s+.5),t.stroke();t.strokeStyle="rgba(0, 230, 255, 0.2)";for(let s=0;s<256;s+=64)t.beginPath(),t.moveTo(s+.5,0),t.lineTo(s+.5,256),t.stroke();const n=new ns(e);return n.colorSpace=Et,n.wrapS=As,n.wrapT=As,n.repeat.set(.5,1.1),n.anisotropy=4,n}function a_(i,e=1024){const t=document.createElement("canvas");t.width=e,t.height=e;const n=t.getContext("2d");n.fillStyle="#000000",n.fillRect(0,0,e,e);const s=34,r=l=>(l+s/2)/s*e,o=[{blur:34,width:11,alpha:.13},{blur:16,width:6,alpha:.24},{blur:6,width:2.6,alpha:.62}];for(const l of o){n.save(),n.globalCompositeOperation="lighter",n.shadowBlur=l.blur,n.lineWidth=l.width,n.lineJoin="round",n.lineCap="round";for(const{poly:c,near:u}of i){const h=u?`rgba(255, 60, 220, ${l.alpha})`:`rgba(60, 230, 255, ${l.alpha})`;n.strokeStyle=h,n.shadowColor=h,n.beginPath(),c.forEach((f,p)=>{const g=r(f.x),v=e-r(f.y);p===0?n.moveTo(g,v):n.lineTo(g,v)}),n.closePath(),n.stroke()}n.restore()}const a=new ns(t);return a.colorSpace=Et,a.wrapS=Rn,a.wrapT=Rn,a.needsUpdate=!0,{texture:a,span:s}}function l_(i,e){const t=t_(i.tiles),n=[],s=[],r=[],o=[],a=[],l=[],c=[];for(const $ of t){const R=n_(i.tiles,$);if(!R.length)continue;R.sort((V,Z)=>Math.abs(Er(Z))-Math.abs(Er(V)));const le=R[0],ee=R.slice(1),Me=Er(le.map(([V,Z])=>[Oa(V),Ba(Z)])),ue=(V,Z)=>{const ne=Er(V.map(([j,be])=>[Oa(j),Ba(be)]));return Z===ne>0?V:[...V].reverse()},De=Me>0?le:[...le].reverse(),me=ee.map(V=>ue(V,!1)),P=r_(De,me),T=new ol(P,{depth:fn,bevelEnabled:!0,bevelThickness:.04,bevelSize:.045,bevelSegments:e.bevelSegments,curveSegments:4});T.rotateX(-Math.PI/2),n.push(T);for(const V of[De,...me]){const Z=za(V,Fa,e.tubeArcSegments);s.push(br(Z,fn+.02,yr,e.tubeRadial));const ne=s_(Z,.235);r.push(br(ne,fn+.02,yr*.86,e.tubeRadial)),o.push(br(Z,.07,yr*.7,Math.max(4,e.tubeRadial-2))),a.push(br(Z,fn*.52,yr*.5,Math.max(4,e.tubeRadial-3)));let j=0;for(let be=1;be<Z.length;be++){const he=Z[be-1],ve=Z[be],Ye=Math.hypot(ve.x-he.x,ve.y-he.y);if(j+=Ye,j<1.6)continue;j=0;const oe=new Gt(.095,fn*.8,.07),Te=Math.atan2(-(ve.y-he.y),ve.x-he.x);oe.rotateY(-Te),oe.translate(ve.x,fn*.42,-ve.y),l.push(oe)}c.push({poly:Z,near:!1})}}const u=$=>{if($.length===0)return null;const R=ka($);return $.forEach(le=>le.dispose()),R},h=u(n),f=u(s),p=u(r),g=u(o),v=u(a),m=u(l),d=o_(),E=new _n({color:Ze.wallBody,metalness:.62,roughness:.22,clearcoat:1,clearcoatRoughness:.32,envMapIntensity:.7,emissiveMap:d,emissive:new fe(10640639),emissiveIntensity:.5});E.onBeforeCompile=$=>{$.uniforms.uRimLow={value:new fe(655384)},$.uniforms.uRimHigh={value:new fe(6036660)},$.uniforms.uWallHeight={value:fn},$.vertexShader=$.vertexShader.replace("#include <common>",`#include <common>
...
`;function Yc(){const i=new bt(420,48,32),e=new _t({vertexShader:u_,fragmentShader:h_,side:Ut,depthWrite:!1,toneMapped:!1,uniforms:{cHorizon:{value:new fe(Ze.skyHorizon)},cLow:{value:new fe(Ze.skyLow)},cMid:{value:new fe(Ze.skyMid)},cHigh:{value:new fe(Ze.skyHigh)},cZenith:{value:new fe(Ze.skyZenith)},cSun:{value:new fe(Ze.sun)},cSunCore:{value:new fe(Ze.sunCore)},sunDir:{value:c_.clone()},time:{value:0},sunMul:{value:1}}}),t=new ge(i,e);return t.frustumCulled=!1,t.renderOrder=-100,t}const f_=`
  varying vec3 vWorld;
  void main() {
...
`;function p_(){const i=new un(2400,2400,1,1);i.rotateX(-Math.PI/2);const e=new _t({vertexShader:f_,fragmentShader:d_,transparent:!0,depthWrite:!1,toneMapped:!1,uniforms:{lineNear:{value:new fe(Ze.gridGlow)},lineFar:{value:new fe(59903)},base:{value:new fe(131078)},time:{value:0},innerFade:{value:20.5},outerFade:{value:620}}}),t=new ge(i,e);return t.position.y=-.06,t.renderOrder=-50,t}function hh(i,e,t,n,s=4){const r=l=>{const c=Math.sin(l*12.9898+i*78.233)*43758.5453;return c-Math.floor(c)},o=[];for(let l=0;l<=e;l++){const c=l/e;let u=0,h=1,f=s,p=0;for(let v=0;v<4;v++){const m=c*f,d=Math.floor(m),E=m-d,b=r(d+v*131),S=r(d+1+v*131),A=.5-.5*Math.cos(E*Math.PI);u+=(b+(S-b)*A)*h,p+=h,h*=n,f=Math.round(f*2.3)}const g=Math.pow(Math.sin(Math.PI*c),.45);o.push(Math.pow(u/p,1.15)*g)}const a=Math.max(...o)||1;return o.map(l=>l/a*t)}function Zc(i,e,t,n,s,r,o,a=4){const c=hh(i,260,t,.42,a),u=[];for(let m=0;m<260;m++){const d=-e/2+m/260*e,E=-e/2+(m+1)/260*e,b=c[m],S=c[m+1];u.push(d,b,0,d,-t*1.6,0,E,S,0),u.push(E,S,0,d,-t*1.6,0,E,-t*1.6,0)}const h=new ct;h.setAttribute("position",new ke(u,3)),h.computeVertexNormals();const f=new ge(h,new et({color:s,toneMapped:!1,fog:!1})),p=[];for(let m=0;m<=260;m++)p.push(new I(-e/2+m/260*e,c[m],.35));const g=new Vu(new ct().setFromPoints(p),new Vr({color:r,transparent:!0,opacity:o,toneMapped:!1,fog:!1})),v=new $e;return v.add(f,g),v.position.z=n,v.renderOrder=-40,v}function m_(i,e){const n=[],s=[],r=new ie(0,0),o=new ie(i*.45,i*.34),a=new ie(i,-i*e);for(let u=0;u<=9;u++){const h=u/9,f=1-h,p=f*f*r.x+2*f*h*o.x+h*h*a.x,g=f*f*r.y+2*f*h*o.y+h*h*a.y,v=2*f*(o.x-r.x)+2*h*(a.x-o.x),m=2*f*(o.y-r.y)+2*h*(a.y-o.y),d=Math.hypot(v,m)||1,E=-m/d,b=v/d,S=i*.085*Math.pow(Math.sin(Math.PI*Math.min(.999,h+.02)),.55);n.push(p+E*S,g+b*S,0),n.push(p-E*S,g-b*S,0)}for(let u=0;u<9;u++){const h=u*2;s.push(h,h+1,h+2,h+1,h+3,h+2)}const l=new ct;l.setAttribute("position",new ke(n,3)),l.setIndex(s),l.computeVertexNormals();const c=[];for(let u=0;u<=9;u++)c.push(u/9,0,u/9,1);return l.setAttribute("uv",new ke(c,2)),l}function g_(i,e){const t=d=>{const E=Math.sin(d*91.7+i*47.3)*43758.5453;return E-Math.floor(E)},n=[],s=[],r=(d,E,b,S,A)=>{const x=d.clone(),y=new tt().compose(E,new ts().setFromEuler(b),S);x.applyMatrix4(y),A.push(x)},o=new $e,a=new et({color:524559,toneMapped:!1,fog:!1,side:gt}),l=new et({color:16726736,toneMapped:!1,transparent:!0,opacity:.12,blending:Ct,depthWrite:!1,side:gt,fog:!1}),c=5,u=(t(1)-.5)*.5;let h=0;const f=new I(1,1,1);for(let d=0;d<c;d++){const E=d/c,b=e/c,S=.3*(1-E*.5),A=.3*(1-(E+1/c)*.5),x=new an(A,S,b,7),y=new I(u*E*E*e*.5,h+b/2,0),C=new Qt(0,0,-u*E*.55);r(x,y,C,f,n),r(x,y,C,new I(1.18,1,1.18),s),x.dispose(),h+=b}const p=new I(u*e*.5,e,0),g=11;for(let d=0;d<g;d++){const E=d/g*Math.PI*2+t(d+7)*.5,b=e*(.32+t(d+20)*.12),S=m_(b,.3+t(d+33)*.22),A=new Qt(0,E,(t(d+61)-.5)*.3,"YZX");r(S,p.clone(),A,new I(1,1,1),n),r(S,p.clone(),A,new I(1.05,1.05,1.05),s),S.dispose()}const v=ka(n),m=ka(s);return n.forEach(d=>d.dispose()),s.forEach(d=>d.dispose()),o.add(new ge(v,a),new ge(m,l)),o}function v_(){const i=new $e;return[[-38,-20,9],[-45,6,8],[-34,30,7],[38,-22,8.5],[46,4,9.5],[33,29,7.5],[-20,-42,8],[19,-44,9],[-56,-12,10.5],[54,-14,9.5],[-62,20,8],[60,22,8.5]].forEach(([t,n,s],r)=>{const o=g_(r*3.1+1,s);o.position.set(t,0,n),o.rotation.y=r*1.7,i.add(o)}),i}function $c(i,e,t,n,s,r){const a=hh(i,26,t,.42,r),l=[],c=[];for(let p=0;p<26;p++){const g=-e/2+p/26*e,v=-e/2+(p+1)/26*e,m=a[p],d=a[p+1];l.push(g,m,0,g,0,0,v,d,0),l.push(v,d,0,g,0,0,v,0,0),c.push(g,m,.2,v,d,.2),p%2===0&&c.push(g,m,.2,g,0,.2)}const u=new ge(new ct().setAttribute("position",new ke(l,3)),new et({color:327693,toneMapped:!1,fog:!1})),h=new Wu(new ct().setAttribute("position",new ke(c,3)),new Vr({color:s,transparent:!0,opacity:.85,toneMapped:!1,fog:!1})),f=new $e;return f.add(u,h),f.position.z=n,f}function __(){const i=new $e,e=[[-52,-120,16,2677247],[46,-108,13,16722902],[8,-132,20,2677247],[-96,-128,18,16722902]];for(const[t,n,s,r]of e){const o=new Wi(s*.85,s,4);o.translate(0,s/2,0);const a=new ge(o,new et({color:262154,toneMapped:!1,fog:!1})),l=new Wu(new Ld(o),new Vr({color:r,transparent:!0,opacity:.75,toneMapped:!1,fog:!1})),c=new $e;c.add(a,l),c.position.set(t,0,n),c.rotation.y=Math.PI/4,i.add(c)}return i}function x_(i=900){const e=new Float32Array(i*3),t=new Float32Array(i),n=new Float32Array(i);for(let o=0;o<i;o++)e[o*3]=(Math.random()-.5)*70,e[o*3+1]=Math.random()*26-1,e[o*3+2]=(Math.random()-.5)*78,t[o]=.25+Math.random()*.85,n[o]=Math.random()*Math.PI*2;const s=new ct;s.setAttribute("position",new ke(e,3)),s.setAttribute("aSpeed",new ke(t,1)),s.setAttribute("aPhase",new ke(n,1));const r=new _t({transparent:!0,depthWrite:!1,blending:Ct,toneMapped:!1,uniforms:{time:{value:0},size:{value:2.2}},vertexShader:`
    ...
    `});return new xd(s,r)}function M_(i,e,t,n){const s=Yc();i.add(s);const r=p_();i.add(r);const o=v_();i.add(o),[$c(2.9,320,17,-92,2677247,7),$c(6.1,440,24,-128,16722902,9)].forEach(E=>i.add(E));const l=__();i.add(l);const c=[Zc(1.7,700,18,-150,Ze.mountains,Ze.mountainRim,.6,9),Zc(4.3,520,10,-104,852516,59903,.38,6)];c.forEach(E=>i.add(E));const u=t.motes?x_(t.motes):null;u&&i.add(u);const h=new Hr(e);h.compileEquirectangularShader();const f=new ku,p=Yc();f.add(p);const g=h.fromScene(f,0,1,500);i.environment=g.texture,p.geometry.dispose(),p.material.dispose(),h.dispose();const v=new ip(16751320,.08);if(v.position.set(7,46,14),v.castShadow=t.shadows,t.shadows){v.shadow.mapSize.set(t.shadowMap,t.shadowMap),v.shadow.camera.near=1,v.shadow.camera.far=140;const E=20;v.shadow.camera.left=-E,v.shadow.camera.right=E,v.shadow.camera.top=E,v.shadow.camera.bottom=-E,v.shadow.bias=-9e-4,v.shadow.normalBias=.03,v.shadow.radius=2}i.add(v),i.add(v.target);const m=new ep(9059583,1179686,.55);i.add(m);const d=new qr(16726736,.45,90,1.6);return d.position.set(0,16,24),i.add(d),{sun:v,setMotes(E){u&&(u.visible=E)},setShafts(E){},setSunVisible(E){s.material.uniforms.sunMul.value=E?1:0},update(E){n&&s.position.copy(n.position),s.material.uniforms.time.value=E,r.material.uniforms.time.value=E,u&&u.visible&&(u.material.uniforms.time.value=E),c[0].position.x=Math.sin(E*.012)*5,c[1].position.x=Math.cos(E*.017)*4},dispose(){g.dispose()}}}const fh={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
